...
- Step 2.64：public pricing dependency-safe copy 本地已实现；公开页定价与付费流程文案移除终身/永久/无限/AI复刻/人格等依赖诱导或机制化表达，并补齐前台可见文案护栏。
...
- 当前不需要为了 Step 2.56 / Step 2.60 / Step 2.61 / Step 2.62 / Step 2.63 再单独 push；本地 Step 2.64 可作为前台定价伦理文案版本合并 push，核心上线闸口仍是上面的 release validation suite。
