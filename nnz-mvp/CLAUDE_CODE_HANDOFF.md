...
Step 2 scoped repository 与 snapshot migration 工具链已经完成到 Step 2.30。最新已推送提交是 `48c9afb feat: add scoped runtime http smoke`；当前本地新增 scoped runtime smoke suite，尚待用户推送。迁移 readiness 还剩 4 个目标未完全收口：
